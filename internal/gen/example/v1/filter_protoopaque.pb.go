...
// 	protoc        (unknown)
// source: example/v1/filter.proto
...
func (x *InvalidRules) Reset() {
	*x = InvalidRules{}
	mi := &file_example_v1_filter_proto_msgTypes[0]
...
func (x *AllRuleTypes) Reset() {
	*x = AllRuleTypes{}
	mi := &file_example_v1_filter_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x case_AllRuleTypes_RequiredOneof) String() string {
	md := file_example_v1_filter_proto_msgTypes[1].Descriptor()
	if x == 0 {
		return "not set"
	}
...
func (x *NestedRules) Reset() {
	*x = NestedRules{}
	mi := &file_example_v1_filter_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x case_NestedRules_RequiredOneof) String() string {
	md := file_example_v1_filter_proto_msgTypes[2].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
var File_example_v1_filter_proto protoreflect.FileDescriptor

const file_example_v1_filter_proto_rawDesc = "" +
	"\n" +
	"\x17example/v1/filter.proto\x12\n" +
	"example.v1\x1a\x1bbuf/validate/validate.proto\"\xa3\x01\n" +
	"\fInvalidRules\x12R\n" +
	...
	"\x0erequired_oneof\x12\x05\xbaH\x02\b\x01\"\xef\x03\n" +
	"\vNestedRules\x12n\n" +
	"\x05field\x18\x01 \x01(\v2\x18.example.v1.AllRuleTypesB>\xbaH;\xba\x018\n" +
	"\x11parent_field_rule\x12\x1cthis field rule always fails\x1a\x05falseR\x05field\x12X\n" +
	"\x06field2\x18\x02 \x01(\tB@\xbaH=\xba\x01:\n" +
	"\x13parent_field_2_rule\x12\x1cthis field rule always fails\x1a\x05falseR\x06field2\x12?\n" +
	"\x0erepeated_field\x18\x03 \x03(\v2\x18.example.v1.AllRuleTypesR\rrepeatedField\x12B\n" +
	"\tmap_field\x18\x04 \x03(\v2%.example.v1.NestedRules.MapFieldEntryR\bmapField\x12!\n" +
	"\voneof_field\x18\x05 \x01(\tH\x00R\n" +
	"oneofField\x1aU\n" +
	"\rMapFieldEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12.\n" +
	"\x05value\x18\x02 \x01(\v2\x18.example.v1.AllRuleTypesR\x05value:\x028\x01B\x17\n" +
	"\x0erequired_oneof\x12\x05\xbaH\x02\b\x01B\xa4\x01\n" +
	"\x0ecom.example.v1B\vFilterProtoP\x01Z<buf.build/go/protovalidate/internal/gen/example/v1;examplev1\xa2\x02\x03EXX\xaa\x02\n" +
	"Example.V1\xca\x02\n" +
	"Example\\V1\xe2\x02\x16Example\\V1\\GPBMetadata\xea\x02\vExample::V1b\x06proto3"

var file_example_v1_filter_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_example_v1_filter_proto_goTypes = []any{
	(*InvalidRules)(nil), // 0: example.v1.InvalidRules
	(*AllRuleTypes)(nil), // 1: example.v1.AllRuleTypes
	(*NestedRules)(nil),  // 2: example.v1.NestedRules
	nil,                  // 3: example.v1.NestedRules.MapFieldEntry
}
var file_example_v1_filter_proto_depIdxs = []int32{
	1, // 0: example.v1.NestedRules.field:type_name -> example.v1.AllRuleTypes
	1, // 1: example.v1.NestedRules.repeated_field:type_name -> example.v1.AllRuleTypes
	3, // 2: example.v1.NestedRules.map_field:type_name -> example.v1.NestedRules.MapFieldEntry
	1, // 3: example.v1.NestedRules.MapFieldEntry.value:type_name -> example.v1.AllRuleTypes
...
func init() { file_example_v1_filter_proto_init() }
func file_example_v1_filter_proto_init() {
	if File_example_v1_filter_proto != nil {
		return
	}
	file_example_v1_filter_proto_msgTypes[1].OneofWrappers = []any{
		(*allRuleTypes_OneofField)(nil),
	}
	file_example_v1_filter_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_example_v1_filter_proto_rawDesc), len(file_example_v1_filter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_example_v1_filter_proto_goTypes,
		DependencyIndexes: file_example_v1_filter_proto_depIdxs,
		MessageInfos:      file_example_v1_filter_proto_msgTypes,
	}.Build()
	File_example_v1_filter_proto = out.File
	file_example_v1_filter_proto_goTypes = nil
	file_example_v1_filter_proto_depIdxs = nil
}
