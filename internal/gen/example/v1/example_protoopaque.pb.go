...
const file_example_v1_example_proto_rawDesc = "" +
	...
	"example.v1\x1a\x1bbuf/validate/validate.proto\"\xac\x01\n" +
	"\x06Person\x12\x18\n" +
	"\x02id\x18\x01 \x01(\x04B\b\xbaH\x052\x03 \xe7\aR\x02id\x12\x1d\n" +
	"\x05email\x18\x02 \x01(\tB\a\xbaH\x04r\x02`\x01R\x05email\x12<\n" +
	"\x04name\x18\x03 \x01(\tB(\xbaH%r#(\x80\x022\x1e^[[:alpha:]]+( [[:alpha:]]+)*$R\x04name\x12+\n" +
	"\x04home\x18\x04 \x01(\v2\x17.example.v1.CoordinatesR\x04home\"c\n" +
	"\vCoordinates\x12)\n" +
	"\x03lat\x18\x01 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x80V@)\x00\x00\x00\x00\x00\x80V\xc0R\x03lat\x12)\n" +
	"\x03lng\x18\x02 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x80f@)\x00\x00\x00\x00\x00\x80f\xc0R\x03lngB\xa5\x01\n" +
	"\x0ecom.example.v1B\fExampleProtoP\x01Z<buf.build/go/protovalidate/internal/gen/example/v1;examplev1\xa2\x02\x03EXX\xaa\x02\n" +
	"Example.V1\xca\x02\n" +
...
var file_example_v1_example_proto_goTypes = []any{
	(*Person)(nil),      // 0: example.v1.Person
	(*Coordinates)(nil), // 1: example.v1.Coordinates
}
var file_example_v1_example_proto_depIdxs = []int32{
	1, // 0: example.v1.Person.home:type_name -> example.v1.Coordinates
