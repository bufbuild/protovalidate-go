...
// 	protoc        (unknown)
// source: example/v1/compile.proto
...
func (x *MismatchRules) Reset() {
	*x = MismatchRules{}
	mi := &file_example_v1_compile_proto_msgTypes[0]
...
func (x *MixedValidInvalidRules) Reset() {
	*x = MixedValidInvalidRules{}
	mi := &file_example_v1_compile_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_example_v1_compile_proto protoreflect.FileDescriptor

const file_example_v1_compile_proto_rawDesc = "" +
	"\n" +
	"\x18example/v1/compile.proto\x12\n" +
	"example.v1\x1a\x1bbuf/validate/validate.proto\"f\n" +
	...
	"\xbaH\ar\x05\n" +
	"\x03fooR\x0fvalidStringRuleB\xa5\x01\n" +
	"\x0ecom.example.v1B\fCompileProtoP\x01Z<buf.build/go/protovalidate/internal/gen/example/v1;examplev1\xa2\x02\x03EXX\xaa\x02\n" +
	"Example.V1\xca\x02\n" +
	"Example\\V1\xe2\x02\x16Example\\V1\\GPBMetadata\xea\x02\vExample::V1b\x06proto3"

var file_example_v1_compile_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_example_v1_compile_proto_goTypes = []any{
	(*MismatchRules)(nil),          // 0: example.v1.MismatchRules
	(*MixedValidInvalidRules)(nil), // 1: example.v1.MixedValidInvalidRules
}
var file_example_v1_compile_proto_depIdxs = []int32{
...
func init() { file_example_v1_compile_proto_init() }
func file_example_v1_compile_proto_init() {
	if File_example_v1_compile_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_example_v1_compile_proto_rawDesc), len(file_example_v1_compile_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_example_v1_compile_proto_goTypes,
		DependencyIndexes: file_example_v1_compile_proto_depIdxs,
		MessageInfos:      file_example_v1_compile_proto_msgTypes,
	}.Build()
	File_example_v1_compile_proto = out.File
	file_example_v1_compile_proto_goTypes = nil
	file_example_v1_compile_proto_depIdxs = nil
}
