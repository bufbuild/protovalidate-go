...
type WrapperTesting struct {
	state         protoimpl.MessageState  `protogen:"hybrid.v1"`
	I32           *wrapperspb.Int32Value  `protobuf:"bytes,1,opt,name=i32,proto3" json:"i32,omitempty"`
	D             *wrapperspb.DoubleValue `protobuf:"bytes,2,opt,name=d,proto3" json:"d,omitempty"`
	F             *wrapperspb.FloatValue  `protobuf:"bytes,3,opt,name=f,proto3" json:"f,omitempty"`
	I64           *wrapperspb.Int64Value  `protobuf:"bytes,4,opt,name=i64,proto3" json:"i64,omitempty"`
	U64           *wrapperspb.UInt64Value `protobuf:"bytes,5,opt,name=u64,proto3" json:"u64,omitempty"`
	U32           *wrapperspb.UInt32Value `protobuf:"bytes,6,opt,name=u32,proto3" json:"u32,omitempty"`
	B             *wrapperspb.BoolValue   `protobuf:"bytes,7,opt,name=b,proto3" json:"b,omitempty"`
	S             *wrapperspb.StringValue `protobuf:"bytes,8,opt,name=s,proto3" json:"s,omitempty"`
	Bs            *wrapperspb.BytesValue  `protobuf:"bytes,9,opt,name=bs,proto3" json:"bs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
