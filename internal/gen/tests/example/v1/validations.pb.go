...
type RequiredOneof struct {
	...
	// Types that are assignable to RequiredOneof:
	//
	//	*RequiredOneof_Fld_1
	//	*RequiredOneof_Fld_2
	RequiredOneof isRequiredOneof_RequiredOneof `protobuf_oneof:"required_oneof"`
}
...
func (m *RequiredOneof) GetRequiredOneof() isRequiredOneof_RequiredOneof {
	if m != nil {
...
func (x *RequiredOneof) GetFld_1() string {
	if x, ok := x.GetRequiredOneof().(*RequiredOneof_Fld_1); ok {
		return x.Fld_1
	}
	return ""
}

func (x *RequiredOneof) GetFld_2() *fieldmaskpb.FieldMask {
	if x, ok := x.GetRequiredOneof().(*RequiredOneof_Fld_2); ok {
		return x.Fld_2
	}
	return nil
}

type isRequiredOneof_RequiredOneof interface {
	isRequiredOneof_RequiredOneof()
}

type RequiredOneof_Fld_1 struct {
	Fld_1 string `protobuf:"bytes,1,opt,name=fld_1,json=fld1,proto3,oneof"`
}

type RequiredOneof_Fld_2 struct {
	Fld_2 *fieldmaskpb.FieldMask `protobuf:"bytes,2,opt,name=fld_2,json=fld2,proto3,oneof"`
}

func (*RequiredOneof_Fld_1) isRequiredOneof_RequiredOneof() {}

func (*RequiredOneof_Fld_2) isRequiredOneof_RequiredOneof() {}
...
var file_tests_example_v1_validations_proto_rawDesc = []byte{
	...
	,
...
var file_tests_example_v1_validations_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_tests_example_v1_validations_proto_goTypes = []interface{}{
	...
	(*RequiredOneof)(nil),                           // 11: tests.example.v1.RequiredOneof
...
var file_tests_example_v1_validations_proto_depIdxs = []int32{
	...
	15, // 8: tests.example.v1.TransitiveFieldConstraint.mask:type_name -> google.protobuf.FieldMask
	16, // 9: tests.example.v1.MultipleStepsTransitiveFieldConstraints.api:type_name -> google.protobuf.Api
	17, // 10: tests.example.v1.FieldOfTypeAny.any:type_name -> google.protobuf.Any
	15, // 11: tests.example.v1.RequiredOneof.fld_2:type_name -> google.protobuf.FieldMask
...
func file_tests_example_v1_validations_proto_init() {
	...
	file_tests_example_v1_validations_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*RequiredOneof_Fld_1)(nil),
		(*RequiredOneof_Fld_2)(nil),
	}
	type x struct{}
