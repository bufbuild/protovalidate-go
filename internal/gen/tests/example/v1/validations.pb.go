...
var file_tests_example_v1_validations_proto_rawDesc = []byte{
	...
	0x79, 0x42, 0xd8, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2e,
	0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x10, 0x56, 0x61, 0x6c, 0x69,
...
var file_tests_example_v1_validations_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_tests_example_v1_validations_proto_goTypes = []interface{}{
	...
	nil,                                             // 11: tests.example.v1.MsgHasMap.Int32mapEntry
	nil,                                             // 12: tests.example.v1.MsgHasMap.StringMapEntry
	nil,                                             // 13: tests.example.v1.MsgHasMap.MessageMapEntry
	(*fieldmaskpb.FieldMask)(nil),                   // 14: google.protobuf.FieldMask
	(*apipb.Api)(nil),                               // 15: google.protobuf.Api
...
var file_tests_example_v1_validations_proto_depIdxs = []int32{
	...
	11, // 5: tests.example.v1.MsgHasMap.int32map:type_name -> tests.example.v1.MsgHasMap.Int32mapEntry
	12, // 6: tests.example.v1.MsgHasMap.string_map:type_name -> tests.example.v1.MsgHasMap.StringMapEntry
	13, // 7: tests.example.v1.MsgHasMap.message_map:type_name -> tests.example.v1.MsgHasMap.MessageMapEntry
	14, // 8: tests.example.v1.TransitiveFieldConstraint.mask:type_name -> google.protobuf.FieldMask
	15, // 9: tests.example.v1.MultipleStepsTransitiveFieldConstraints.api:type_name -> google.protobuf.Api
	16, // 10: tests.example.v1.FieldOfTypeAny.any:type_name -> google.protobuf.Any
