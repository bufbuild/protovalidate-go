...
var file_tests_example_v1_validations_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_tests_example_v1_validations_proto_goTypes = []interface{}{
	...
	nil,                               // 8: tests.example.v1.MsgHasMap.Int32mapEntry
	nil,                               // 9: tests.example.v1.MsgHasMap.StringMapEntry
	nil,                               // 10: tests.example.v1.MsgHasMap.MessageMapEntry
...
var file_tests_example_v1_validations_proto_depIdxs = []int32{
	...
	8,  // 5: tests.example.v1.MsgHasMap.int32map:type_name -> tests.example.v1.MsgHasMap.Int32mapEntry
	9,  // 6: tests.example.v1.MsgHasMap.string_map:type_name -> tests.example.v1.MsgHasMap.StringMapEntry
	10, // 7: tests.example.v1.MsgHasMap.message_map:type_name -> tests.example.v1.MsgHasMap.MessageMapEntry
	11, // 8: tests.example.v1.TransitiveFieldConstraint.mask:type_name -> google.protobuf.FieldMask
	2,  // 9: tests.example.v1.MsgHasMap.MessageMapEntry.value:type_name -> tests.example.v1.LoopRecursiveA
