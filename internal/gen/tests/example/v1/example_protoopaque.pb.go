...
type Person struct {
	...
	xxx_hidden_Home  *Coordinates           `protobuf:"bytes,4,opt,name=home,proto3" json:"home,omitempty"`
...
type Coordinates struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Lat float64                `protobuf:"fixed64,1,opt,name=lat,proto3" json:"lat,omitempty"`
	xxx_hidden_Lng float64                `protobuf:"fixed64,2,opt,name=lng,proto3" json:"lng,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
