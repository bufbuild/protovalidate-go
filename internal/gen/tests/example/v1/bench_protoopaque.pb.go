...
type BenchCrossReference struct {
	state              protoimpl.MessageState        `protogen:"opaque.v1"`
	xxx_hidden_Entries *[]*BenchCrossReference_Entry `protobuf:"bytes,1,rep,name=entries,proto3"`
	xxx_hidden_Rules   *[]*BenchCrossReference_Rule  `protobuf:"bytes,2,rep,name=rules,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type BenchCrossReference_Entry struct {
	state          protoimpl.MessageState   `protogen:"opaque.v1"`
	xxx_hidden_Key *BenchCrossReference_Key `protobuf:"bytes,1,opt,name=key,proto3"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type BenchCrossReference_Rule struct {
	state           protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_Refs *[]*BenchCrossReference_Key `protobuf:"bytes,1,rep,name=refs,proto3"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
