...
type MaxString struct {
	...
	xxx_hidden_Salutation string                 `protobuf:"bytes,5,opt,name=salutation,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *MaxString) GetSalutation() string {
	if x != nil {
		return x.xxx_hidden_Salutation
	}
	return ""
}
...
func (b0 MaxString_builder) Build() *MaxString {
	...
	x.xxx_hidden_Salutation = b.Salutation
	return m0
}
