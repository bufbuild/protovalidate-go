...
func file_buf_validate_conformance_cases_wkt_timestamp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_validate_conformance_cases_wkt_timestamp_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimestampNotLTNow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_validate_conformance_cases_wkt_timestamp_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimestampNotGTNow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_validate_conformance_cases_wkt_timestamp_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_buf_validate_conformance_cases_wkt_timestamp_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_buf_validate_conformance_cases_wkt_timestamp_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimestampExample); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
