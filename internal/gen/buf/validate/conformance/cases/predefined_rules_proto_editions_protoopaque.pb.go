...
type PredefinedEnumRuleEdition2023 struct {
	state                  protoimpl.MessageState                        `protogen:"opaque.v1"`
	xxx_hidden_Val         PredefinedEnumRuleEdition2023_EnumEdition2023 `protobuf:"varint,1,opt,name=val,enum=buf.validate.conformance.cases.PredefinedEnumRuleEdition2023_EnumEdition2023"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type PredefinedRepeatedRuleEdition2023 struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val []uint64               `protobuf:"varint,1,rep,packed,name=val"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type PredefinedMapRuleEdition2023 struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val map[uint64]uint64      `protobuf:"bytes,1,rep,name=val" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type PredefinedAndCustomRuleEdition2023 struct {
	...
	xxx_hidden_B           *PredefinedAndCustomRuleEdition2023_Nested `protobuf:"bytes,2,opt,name=b"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
var file_buf_validate_conformance_cases_predefined_rules_proto_editions_proto_rawDesc = string([]byte{
