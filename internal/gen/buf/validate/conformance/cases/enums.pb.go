...
func (x *EnumInsideOneof) SetVal(v TestEnum) {
	x.Foo = &EnumInsideOneof_Val{v}
}

func (x *EnumInsideOneof) SetVal2(v TestEnum) {
	x.Bar = &EnumInsideOneof_Val2{v}
}
...
func (x *EnumInsideOneof) HasVal() bool {
	...
	_, ok := x.Foo.(*EnumInsideOneof_Val)
	return ok
}
...
func (x *EnumInsideOneof) HasVal2() bool {
	...
	_, ok := x.Bar.(*EnumInsideOneof_Val2)
	return ok
}
...
func (x *EnumInsideOneof) ClearVal() {
	if _, ok := x.Foo.(*EnumInsideOneof_Val); ok {
		x.Foo = nil
	}
}
...
func (x *EnumInsideOneof) ClearVal2() {
	if _, ok := x.Bar.(*EnumInsideOneof_Val2); ok {
		x.Bar = nil
	}
}
...
func (b0 EnumInsideOneof_builder) Build() *EnumInsideOneof {
	...
	_, _ = b, x
	if b.Val != nil {
		x.Foo = &EnumInsideOneof_Val{*b.Val}
	}
	if b.Val2 != nil {
		x.Bar = &EnumInsideOneof_Val2{*b.Val2}
	}
	return m0
}
