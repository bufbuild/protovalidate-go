...
type IgnoreEmptyEditionsMessageExplicitPresence struct {
	state          protoimpl.MessageState                          `protogen:"opaque.v1"`
	xxx_hidden_Val *IgnoreEmptyEditionsMessageExplicitPresence_Msg `protobuf:"bytes,1,opt,name=val" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type IgnoreEmptyEditionsMessageExplicitPresenceDelimited struct {
	state          protoimpl.MessageState                                   `protogen:"opaque.v1"`
	xxx_hidden_Val *IgnoreEmptyEditionsMessageExplicitPresenceDelimited_Msg `protobuf:"group,1,opt,name=Msg,json=val" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type IgnoreEmptyEditionsMessageLegacyRequired struct {
	state          protoimpl.MessageState                        `protogen:"opaque.v1"`
	xxx_hidden_Val *IgnoreEmptyEditionsMessageLegacyRequired_Msg `protobuf:"bytes,1,req,name=val" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type IgnoreEmptyEditionsMessageLegacyRequiredDelimited struct {
	state          protoimpl.MessageState                                 `protogen:"opaque.v1"`
	xxx_hidden_Val *IgnoreEmptyEditionsMessageLegacyRequiredDelimited_Msg `protobuf:"group,1,req,name=Msg,json=val" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
var file_buf_validate_conformance_cases_ignore_empty_proto_editions_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0xb1, 0x02, 0x0a, 0x22, 0x63, 0x6f,
	...
	0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x3a, 0x3a, 0x43, 0x61, 0x73, 0x65, 0x73, 0x62, 0x08, 0x65,
