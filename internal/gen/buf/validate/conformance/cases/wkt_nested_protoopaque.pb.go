...
type WktLevelOne struct {
	...
	xxx_hidden_Two *WktLevelOne_WktLevelTwo `protobuf:"bytes,1,opt,name=two,proto3" json:"two,omitempty"`
...
type WktLevelOne_WktLevelTwo struct {
	state            protoimpl.MessageState                 `protogen:"opaque.v1"`
	xxx_hidden_Three *WktLevelOne_WktLevelTwo_WktLevelThree `protobuf:"bytes,1,opt,name=three,proto3" json:"three,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
