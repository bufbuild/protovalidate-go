...
type EnumNone struct {
	...
	xxx_hidden_Val TestEnum               `protobuf:"varint,1,opt,name=val,proto3,enum=buf.validate.conformance.cases.TestEnum" json:"val,omitempty"`
...
func (x *EnumNone) SetVal(v TestEnum) {
	x.xxx_hidden_Val = v
}
...
func (x *EnumConst) SetVal(v TestEnum) {
	x.xxx_hidden_Val = v
}
...
type EnumAliasConst struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val TestEnumAlias          `protobuf:"varint,1,opt,name=val,proto3,enum=buf.validate.conformance.cases.TestEnumAlias" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *EnumIn) SetVal(v TestEnum) {
	x.xxx_hidden_Val = v
}
...
func (x *EnumNotIn) SetVal(v TestEnum) {
	x.xxx_hidden_Val = v
}
...
type EnumExternal struct {
	state          protoimpl.MessageState         `protogen:"opaque.v1"`
	xxx_hidden_Val other_package.Embed_Enumerated `protobuf:"varint,1,opt,name=val,proto3,enum=buf.validate.conformance.cases.other_package.Embed_Enumerated" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type EnumExternal2 struct {
	state          protoimpl.MessageState                           `protogen:"opaque.v1"`
	xxx_hidden_Val other_package.Embed_DoubleEmbed_DoubleEnumerated `protobuf:"varint,1,opt,name=val,proto3,enum=buf.validate.conformance.cases.other_package.Embed_DoubleEmbed_DoubleEnumerated" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type RepeatedEnumDefined struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val []TestEnum             `protobuf:"varint,1,rep,packed,name=val,proto3,enum=buf.validate.conformance.cases.TestEnum" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type RepeatedExternalEnumDefined struct {
	state          protoimpl.MessageState           `protogen:"opaque.v1"`
	xxx_hidden_Val []other_package.Embed_Enumerated `protobuf:"varint,1,rep,packed,name=val,proto3,enum=buf.validate.conformance.cases.other_package.Embed_Enumerated" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (b0 RepeatedExternalEnumDefined_builder) Build() *RepeatedExternalEnumDefined {
	m0 := &RepeatedExternalEnumDefined{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Val = b.Val
	return m0
...
type RepeatedYetAnotherExternalEnumDefined struct {
	state          protoimpl.MessageState                 `protogen:"opaque.v1"`
	xxx_hidden_Val []yet_another_package.Embed_Enumerated `protobuf:"varint,1,rep,packed,name=val,proto3,enum=buf.validate.conformance.cases.yet_another_package.Embed_Enumerated" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (b0 RepeatedYetAnotherExternalEnumDefined_builder) Build() *RepeatedYetAnotherExternalEnumDefined {
	m0 := &RepeatedYetAnotherExternalEnumDefined{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Val = b.Val
	return m0
...
type MapEnumDefined struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val map[string]TestEnum    `protobuf:"bytes,1,rep,name=val,proto3" json:"val,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=buf.validate.conformance.cases.TestEnum"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type MapExternalEnumDefined struct {
	state          protoimpl.MessageState                    `protogen:"opaque.v1"`
	xxx_hidden_Val map[string]other_package.Embed_Enumerated `protobuf:"bytes,1,rep,name=val,proto3" json:"val,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=buf.validate.conformance.cases.other_package.Embed_Enumerated"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type EnumInsideOneof struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Foo isEnumInsideOneof_Foo  `protobuf_oneof:"foo"`
	xxx_hidden_Bar isEnumInsideOneof_Bar  `protobuf_oneof:"bar"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *EnumInsideOneof) GetVal() TestEnum {
	if x != nil {
		if x, ok := x.xxx_hidden_Foo.(*enumInsideOneof_Val); ok {
			return x.Val
		}
	}
	return TestEnum_TEST_ENUM_UNSPECIFIED
...
func (x *EnumInsideOneof) GetVal2() TestEnum {
	if x != nil {
		if x, ok := x.xxx_hidden_Bar.(*enumInsideOneof_Val2); ok {
			return x.Val2
		}
	}
	return TestEnum_TEST_ENUM_UNSPECIFIED
...
func (x *EnumInsideOneof) SetVal(v TestEnum) {
	x.xxx_hidden_Foo = &enumInsideOneof_Val{v}
}

func (x *EnumInsideOneof) SetVal2(v TestEnum) {
	x.xxx_hidden_Bar = &enumInsideOneof_Val2{v}
}
...
func (x *EnumInsideOneof) HasVal() bool {
	...
	_, ok := x.xxx_hidden_Foo.(*enumInsideOneof_Val)
	return ok
}
...
func (x *EnumInsideOneof) HasVal2() bool {
	...
	_, ok := x.xxx_hidden_Bar.(*enumInsideOneof_Val2)
	return ok
}
...
func (x *EnumInsideOneof) ClearVal() {
	if _, ok := x.xxx_hidden_Foo.(*enumInsideOneof_Val); ok {
		x.xxx_hidden_Foo = nil
	}
}
...
func (x *EnumInsideOneof) ClearVal2() {
	if _, ok := x.xxx_hidden_Bar.(*enumInsideOneof_Val2); ok {
		x.xxx_hidden_Bar = nil
	}
}
...
func (x *EnumInsideOneof) WhichFoo() case_EnumInsideOneof_Foo {
	if x == nil {
		return EnumInsideOneof_Foo_not_set_case
	}
	switch x.xxx_hidden_Foo.(type) {
	case *enumInsideOneof_Val:
		return EnumInsideOneof_Val_case
	default:
		return EnumInsideOneof_Foo_not_set_case
	}
}
...
func (x *EnumInsideOneof) WhichBar() case_EnumInsideOneof_Bar {
	if x == nil {
		return EnumInsideOneof_Bar_not_set_case
	}
	switch x.xxx_hidden_Bar.(type) {
	case *enumInsideOneof_Val2:
		return EnumInsideOneof_Val2_case
	default:
		return EnumInsideOneof_Bar_not_set_case
	}
}
...
type EnumInsideOneof_builder struct {
	...
	// Fields of oneof xxx_hidden_Foo:
	Val *TestEnum
	// -- end of xxx_hidden_Foo
	// Fields of oneof xxx_hidden_Bar:
	Val2 *TestEnum
	// -- end of xxx_hidden_Bar
}
...
func (b0 EnumInsideOneof_builder) Build() *EnumInsideOneof {
	...
	_, _ = b, x
	if b.Val != nil {
		x.xxx_hidden_Foo = &enumInsideOneof_Val{*b.Val}
	}
	if b.Val2 != nil {
		x.xxx_hidden_Bar = &enumInsideOneof_Val2{*b.Val2}
	}
	return m0
}

type case_EnumInsideOneof_Foo protoreflect.FieldNumber

func (x case_EnumInsideOneof_Foo) String() string {
	md := file_buf_validate_conformance_cases_enums_proto_msgTypes[16].Descriptor()
	if x == 0 {
		return "not set"
	}
...
type case_EnumInsideOneof_Bar protoreflect.FieldNumber

func (x case_EnumInsideOneof_Bar) String() string {
	md := file_buf_validate_conformance_cases_enums_proto_msgTypes[16].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var file_buf_validate_conformance_cases_enums_proto_rawDesc = []byte{
	...
	0x1a, 0x02, 0x10, 0x01, 0x42, 0x9e, 0x02, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75, 0x66,
	0x2e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x6f, 0x72,
	0x6d, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x63, 0x61, 0x73, 0x65, 0x73, 0x42, 0x0a, 0x45, 0x6e, 0x75,
	0x6d, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75,
