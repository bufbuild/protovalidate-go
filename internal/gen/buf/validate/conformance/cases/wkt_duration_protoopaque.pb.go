...
type DurationFieldWithOtherFields struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_DurationVal *durationpb.Duration   `protobuf:"bytes,1,opt,name=duration_val,json=durationVal,proto3" json:"duration_val,omitempty"`
	xxx_hidden_IntVal      int32                  `protobuf:"varint,2,opt,name=int_val,json=intVal,proto3" json:"int_val,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
