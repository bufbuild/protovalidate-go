...
type Int64BigConstraints struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_LtPos       int64                  `protobuf:"varint,1,opt,name=lt_pos,json=ltPos,proto3" json:"lt_pos,omitempty"`
	xxx_hidden_LtNeg       int64                  `protobuf:"varint,2,opt,name=lt_neg,json=ltNeg,proto3" json:"lt_neg,omitempty"`
	xxx_hidden_GtPos       int64                  `protobuf:"varint,3,opt,name=gt_pos,json=gtPos,proto3" json:"gt_pos,omitempty"`
	xxx_hidden_GtNeg       int64                  `protobuf:"varint,4,opt,name=gt_neg,json=gtNeg,proto3" json:"gt_neg,omitempty"`
	xxx_hidden_LtePos      int64                  `protobuf:"varint,5,opt,name=lte_pos,json=ltePos,proto3" json:"lte_pos,omitempty"`
	xxx_hidden_LteNeg      int64                  `protobuf:"varint,6,opt,name=lte_neg,json=lteNeg,proto3" json:"lte_neg,omitempty"`
	xxx_hidden_GtePos      int64                  `protobuf:"varint,7,opt,name=gte_pos,json=gtePos,proto3" json:"gte_pos,omitempty"`
	xxx_hidden_GteNeg      int64                  `protobuf:"varint,8,opt,name=gte_neg,json=gteNeg,proto3" json:"gte_neg,omitempty"`
	xxx_hidden_ConstantPos int64                  `protobuf:"varint,9,opt,name=constant_pos,json=constantPos,proto3" json:"constant_pos,omitempty"`
	xxx_hidden_ConstantNeg int64                  `protobuf:"varint,10,opt,name=constant_neg,json=constantNeg,proto3" json:"constant_neg,omitempty"`
	xxx_hidden_In          int64                  `protobuf:"varint,11,opt,name=in,proto3" json:"in,omitempty"`
	xxx_hidden_Notin       int64                  `protobuf:"varint,12,opt,name=notin,proto3" json:"notin,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type Int64LTEOptional struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val         int64                  `protobuf:"varint,1,opt,name=val,proto3,oneof" json:"val,omitempty"`
