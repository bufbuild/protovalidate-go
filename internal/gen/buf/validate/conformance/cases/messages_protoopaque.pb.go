...
type TestMsg struct {
	...
	xxx_hidden_Nested *TestMsg               `protobuf:"bytes,2,opt,name=nested,proto3" json:"nested,omitempty"`
...
type MessageNone struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val *MessageNone_NoneMsg   `protobuf:"bytes,1,opt,name=val,proto3" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type Message struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val *TestMsg               `protobuf:"bytes,1,opt,name=val,proto3" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type MessageCrossPackage struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val *other_package.Embed   `protobuf:"bytes,1,opt,name=val,proto3" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type MessageRequiredButOptional struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Val *TestMsg               `protobuf:"bytes,1,opt,name=val,proto3,oneof" json:"val,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
