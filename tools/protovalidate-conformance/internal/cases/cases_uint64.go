...
func uint64Suite() suites.Suite {
	return suites.Suite{
		"none/valid": {
			Message:  &cases.UInt64None{Val: 123},
			Expected: results.Success(true),
		},
		"const/valid": {
			Message:  &cases.UInt64Const{Val: 1},
			Expected: results.Success(true),
		},
		"const/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					Rule:   results.FieldPath("uint64.const"),
					RuleId: proto.String("uint64.const"),
				},
			),
		},
		"in/valid": {
		...
		"in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.in"),
					RuleId: proto.String("uint64.in"),
				},
			),
		},
		"not_in/valid": {
		...
		"not_in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.not_in"),
					RuleId: proto.String("uint64.not_in"),
				},
			),
		},
		"lt/valid/less": {
		...
		"lt/invalid/equal": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.lt"),
					RuleId: proto.String("uint64.lt"),
				},
			),
		},
		"lt/invalid/greater": {
		...
		"lte/valid/equal": {
			Message:  &cases.UInt64LTE{Val: 64},
			Expected: results.Success(true),
		},
		"lte/invalid/greater": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.lte"),
					RuleId: proto.String("uint64.lte"),
				},
			),
		},
		"gt/valid/greater": {
		...
		"gte/invalid/less": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.gte"),
					RuleId: proto.String("uint64.gte"),
				},
			),
		},
		...
		"gt_lt/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.gt"),
					RuleId: proto.String("uint64.gt_lt"),
				},
			),
		},
		...
		"gt_lt/exclusive/valid/below": {
			Message:  &cases.UInt64ExLTGT{Val: 4},
			Expected: results.Success(true),
		},
		"gt_lt/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.gt"),
					RuleId: proto.String("uint64.gt_lt_exclusive"),
				},
			),
		},
		...
		"gte_lte/inclusive/valid/max": {
			Message:  &cases.UInt64GTELTE{Val: 256},
			Expected: results.Success(true),
		},
		"gte_lte/inclusive/valid/min": {
			Message:  &cases.UInt64GTELTE{Val: 128},
			Expected: results.Success(true),
		},
		"gte_lte/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.gte"),
					RuleId: proto.String("uint64.gte_lte"),
				},
			),
		},
		...
		"gte_lte/exclusive/valid/below": {
			Message:  &cases.UInt64ExGTELTE{Val: 100},
			Expected: results.Success(true),
		},
		"gte_lte/exclusive/valid/max": {
			Message:  &cases.UInt64ExGTELTE{Val: 256},
			Expected: results.Success(true),
		},
		"gte_lte/exclusive/valid/min": {
			Message:  &cases.UInt64ExGTELTE{Val: 128},
			Expected: results.Success(true),
		},
		"gte_lte/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint64.gte"),
					RuleId: proto.String("uint64.gte_lte_exclusive"),
				},
			),
		},
		...
		"ignore_empty/valid/within": {
			Message:  &cases.UInt64Ignore{Val: 200},
			Expected: results.Success(true),
		},
