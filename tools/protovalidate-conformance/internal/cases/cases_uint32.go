		...
		"const/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					RuleId: proto.String("uint32.const"),
				},
			),
		},
		"in/valid": {
		...
		"not_in/invalid": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					RuleId: proto.String("uint32.not_in"),
				},
			),
		},
		"lt/valid/less": {
		...
		"lte/invalid/greater": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					RuleId: proto.String("uint32.lte"),
				},
			),
		},
		"gt/valid/greater": {
		...
		"gte/invalid/less": {
			...
			Expected: results.Violations(
				&validate.Violation{
					...
					RuleId: proto.String("uint32.gte"),
				},
			),
		},
		...
		"gt_lt/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint32.gt"),
					RuleId: proto.String("uint32.gt_lt"),
				},
			),
		},
		...
		"gt_lt/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint32.gt"),
					RuleId: proto.String("uint32.gt_lt_exclusive"),
				},
			),
		},
		...
		"gte_lte/inclusive/invalid/above": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint32.gte"),
					RuleId: proto.String("uint32.gte_lte"),
				},
			),
		},
		...
		"gte_lte/exclusive/invalid/within": {
			...
			Expected: results.Violations(
				&validate.Violation{
					Field:  results.FieldPath("val"),
					Rule:   results.FieldPath("uint32.gte"),
					RuleId: proto.String("uint32.gte_lte_exclusive"),
				},
			),
		},
